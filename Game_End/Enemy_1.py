...
class Enemy_1 :
    ...
    def __init__(self,x,y,speed_walk,speed_run,gravity,frame_rate_ms):
        ...
        self.lista_balas = []
        self.ammo = 1
        self.rect_radar = pygame.Rect(self.rect.x-ANCHO_VENTANA,self.rect.y+120,4000,10)
    ...
    def update(self,delta_ms,lista_plataformas,pos_x_y):
    ...
    def shoot(self,pos_x_y):
        ...
        if self.rect_radar.colliderect(pos_x_y):
            ...
            if self.ammo > 0 :         
                self.lista_balas.append(Bala (self.rect_gun.x,self.rect_gun.y,self.direction))
                self.ammo -= 1          
        else:
            self.reload()
...
class Enemy_02(Enemy_1):
    def __init__(self, x, y, speed_walk, speed_run, gravity):
        ...
        self.rect.x = x
        self.rect.y = y  
        self.rect_weakpoint = pygame.Rect (self.rect.x,self.rect.y, 40, 50)    
        self.avanzar = False
        self.move_x = 8
        self.move_y = 0  
        self.speed_walk =  speed_walk
    ...
    def update(self, delta_ms, lista_plataformas,pos_x_y):
        return super().update(delta_ms, lista_plataformas,pos_x_y)
    def is_on_platform(self,lista_plataformas):
