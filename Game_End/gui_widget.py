...
class Widget:
    ...
    def __init__(self,master_form,x,y,w,h,color_background,color_border,image_background,text,font="Castellar",font_size=15,font_color=RED):
    
        self.master_form = master_form #Objeto formulario
        self.x = x  
        self.y = y
        self.w = w
        self.h = h
